  ...
  return (
    <section className="about-section" id="sobre">
      <div className="about-container">
        ...
        <div className="about-content">
          <ScrollReveal animation="fade-right">
            ...
            <p className="about-desc">
              Não é truque de vitrine, é como a gente atende todos os dias. A
              One nasceu pra ser diferente, e isso aparece até em quem entrega o
              seu lanche. Vem ver de perto como funciona.
            </p>
        ...
        {/* Imagem Ilustrativa - Deslizando da Direita com atraso */}
